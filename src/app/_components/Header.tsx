...
const Header = () => {
  return (
    <motion.header
      ...
      className="opacity-0 w-full h-16 bg-gradient-to-b from-[#222222] to-[#1a1a1a] fixed top-0 left-0 rounded-b-xl shadow-md shadow-black/30 z-50 md:w-4/5 md:left-1/2 md:translate-x-[-50%]"
    >
